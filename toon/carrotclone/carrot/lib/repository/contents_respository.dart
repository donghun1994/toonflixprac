...
import 'package:carrot/repository/local_strage_repository.dart';
...
//List<Map<String, String>>
  ...
  Future<List<dynamic>> loadFavoriteContents() async {
    String jsonString = await getStroredValue(MY_FAVOIRTE_STORE_KEY);
    List<dynamic> json = jsonDecode(jsonString);

    return json;
  }

  void updateFavoriteContent(List updateFavoriteContent) async {
    await storeValue(MY_FAVOIRTE_STORE_KEY, jsonEncode(updateFavoriteContent));
  }

  addMyFaoviteContent(Map<String, dynamic> content) async {
